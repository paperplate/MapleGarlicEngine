...
export class Engine
{
 public:
   Engine()
      : mIsRunning(true), mWindow(nullptr), mDevice(nullptr), mTimeUniform({}), mPipeline(nullptr),
   ...
   {
      mWindow = {
         SDL_CreateWindow("MapleGarlicEngine", 640, 480, SDL_WINDOW_HIDDEN | SDL_WINDOW_RESIZABLE)};
      if (mWindow == nullptr)
      {
